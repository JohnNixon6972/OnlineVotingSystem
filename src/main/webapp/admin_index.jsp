            ...
            <div class="row tm-section-pad-top">
                <div class="col-lg-4">
                    ...
                    <h4 class="text-center tm-text-primary mb-4">
                        <a href="./createevent.html">Create Event for Election</a>
                    </h4>
                    <p>
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    ...
                    <h4 class="text-center tm-text-primary mb-4">
                        <a href="AddPositions.jsp">Add positions for a Election</a>
                    </h4>
                    <p>
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    ...
                    <h4 class="text-center tm-text-primary mb-4">
                        <a href="viewstats.jsp">View Stats of Election</a>
                    </h4>
                    <p>
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    <i class="fas fa-4x fa-city text-center tm-icon"></i>
                    <h4 class="text-center tm-text-primary mb-4">
                        <a href="publishresult.jsp">Publish Result Of Election</a>
                    </h4>
                    <p>
                        Donec vestibulum libero nisl. Curabitur ac orci ac lorem blandit volutpat. Sed ac sodales nibh, ut porttitor elit. Sed id dui mi. Vestibulum ante ipsum primis in faucibus.
                    </p>
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    <i class="fas fa-4x fa-city text-center tm-icon"></i>
                    <h4 class="text-center tm-text-primary mb-4">
                        <a href="Cancelelection.jsp">Cancel Election</a>
                    </h4>
                    <p>
                        Donec vestibulum libero nisl. Curabitur ac orci ac lorem blandit volutpat. Sed ac sodales nibh, ut porttitor elit. Sed id dui mi. Vestibulum ante ipsum primis in faucibus.
                    </p>
