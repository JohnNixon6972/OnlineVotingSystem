		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Add Positions</h2>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<h4 class="text-center mb-4">Available Elections To Vote</h4>
					<div class="table-wrap">
				        ...
				        try {
				            ...
				            while(rs.next()){				                
				                ...
				                out.print("<td><a href='posdescadd.jsp?e_id="+e_idstr+"' class='btn btn-primary'>Add Positions</a></td>");
				            }
