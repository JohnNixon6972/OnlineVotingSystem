		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Applying As A Candidate</h2>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<h4 class="text-center mb-4">Eligible Elections To Stand as A Candidate</h4>
				        ...
				        try {
				            ...
				            ResultSet rs;
					            ...
					            while(rs.next()){
					                ...
					                out.print("<td><a href='approvecandidate.jsp?e_id="+e_id+"' class='btn btn-primary'>Apply</a></td>");
					            }
