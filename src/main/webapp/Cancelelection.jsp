		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Election Cancellation</h2>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<h4 class="text-center mb-4">Elections That Can be Cancelled</h4>
					<div class="table-wrap">
				        ...
				        try {
				            ...
				            while(rs.next()){				                
				                ...
				                out.print("<td><a href='cancleelectionconfirm.jsp?e_id="+e_idstr+"' class='btn btn-primary'>Cancel Election</a></td>");
				            }
